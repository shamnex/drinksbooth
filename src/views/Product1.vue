        ...
        <v-container>
          <v-layout justify-space-between>
            <v-flex sm7 class="product-content">
              <p
                class="heading-primary product-content__title"
              >The amazing Red Wine Drink from Kogi State</p>
              <v-rating readonly color="orange" v-model="rating"></v-rating>

              <p
                class="product-content__description mt-3"
              >Lorem ipsum dolor sit, amet consectetur adipisicing elit. Debitis rem voluptates totam alias doloribus, eos soluta esse magnam consequatur nihil nulla amet omnis perspiciatis. Suscipit iste beatae nihil provident odio.</p>

              <p class="product-content__price mt-5">49,000.00</p>
              <div class="product-content__ctas">
                <div class="product-content__increment">
                  <v-btn flat icon back="#fff">
                    <v-icon>remove</v-icon>
                  </v-btn>
                  <span class="product-content__increment__quantity">200</span>
